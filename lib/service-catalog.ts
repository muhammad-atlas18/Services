...
const categoryMeta = {
  solar: { label: "Solar Services", route: "/services/solar", image: "/images/solar-panel-installation-lahore.webp", imageAlt: "Solar technicians installing rooftop panels in Lahore", intro: "Planning, installation, connection, diagnostics, cleaning and ongoing solar support for Lahore properties.", cardDescription: "Professional solar installation, diagnostics, cleaning and maintenance for Lahore properties." },
  electrical: { label: "Electrical Services", route: "/services/electrical", image: "/images/electrical-wiring-lahore.webp", imageAlt: "Electrician completing organised wiring in a Lahore property", intro: "New wiring, rewiring, fault diagnosis, distribution-board and electrical fixture services.", cardDescription: "Safe wiring, fault diagnosis, distribution-board and electrical fixture services." },
  ac: { label: "AC Services", route: "/services/ac", image: "/images/ac-installation-lahore.webp", imageAlt: "Technician installing a split AC in a Lahore home", intro: "Installation, fault diagnosis, maintenance, shifting and cooling or leakage support.", cardDescription: "Reliable AC installation, repair, maintenance and cooling-performance support." },
  "home-appliances": { label: "Home Appliance Services", route: "/services/home-appliances", image: "/images/home-appliances/category-hero.webp", imageAlt: "Home appliance technician servicing household appliances in Lahore", intro: "Diagnosis and repair for essential kitchen and laundry appliances across Lahore.", cardDescription: "Professional diagnosis and repair for essential kitchen and laundry appliances." },
} as const;
