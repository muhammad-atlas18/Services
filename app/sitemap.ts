...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPaths = ["", "/services/solar", "/services/electrical", "/services/ac", "/services/home-appliances", "/solar-services-lahore", "/electrician-services-lahore", "/ac-services-lahore", "/projects", "/about", "/contact", "/privacy-policy", "/terms"];
