...
export default async function ServicePage({ params }: { params: Promise<{ service: string }> }) {
  ...
  return <PageShell>
    <section className="pageHero categoryHero"><div className="container"><span className="eyebrow">{service.label} · Lahore</span><h1>{service.title}</h1><p className="lead">{service.description}</p><div className="actions"><WhatsAppLink service={service.label}>Discuss this service</WhatsAppLink></div></div></section>
